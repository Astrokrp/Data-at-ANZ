...
***The model’s adjusted R^2 also shows 15% of variation in customers annual salary which is not enough. hence, it is risky to use this linear model to predict customer's income. More data is required to develop a more significant and reliable model.***